...
const getTripTypeLabel = (value) => {
    ...
    if (normalized === 'flexible') return 'Linh hoạt';
    return value || '-';
};
                    ...
                    <div className="admin-booking-page__left-panel admin-booking-page__left-panel--sticky">
                        <div className="admin-booking-page__toolbar">
                            <div className="admin-booking-page__search">
                                <FiSearch />
                                <input type="text" value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Tìm cuốc xe, tên, biển số..." />
                            </div>
                                ...
                                <>
                                            ...
                                            {filteredBookings.length === 0 ? (
                                                ...
                                                filteredBookings.map((booking) => (
                                                    ...
                                                    >
                                                        ...
                                                        <td><span className={`booking-status ${getStatusClass(booking.bookingStatus)}`}>{STATUS_LABELS[booking.bookingStatus] || booking.bookingStatus || '-'}</span></td>
                                    ...
                                    <div className="admin-booking-page__table-footer">
                                        ...
                                        <div className="admin-booking-page__page-size">
                                            ...
                                            <span>/ trang</span>
                                            <strong>Tổng {summary.total || filteredBookings.length} cuốc xe</strong>
                                        </div>
                                    </div>
                                </>
                            )}
                                ...
                                {detailLoading ? (
                                    ...
                                    <>
                                        ...
                                        <div className="admin-booking-page__status-line">
                                            <span className={`booking-status ${getStatusClass(activeBooking.bookingStatus)}`}>{STATUS_LABELS[activeBooking.bookingStatus] || activeBooking.bookingStatus || '-'}</span>
